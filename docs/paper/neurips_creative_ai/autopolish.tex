...
Our method is deliberately straightforward and training-free; we describe a viewer in plain text by giving their age, education, familiarity with art, personality, and nationality. In a role-play scenario, we then prompt the model to react to an image as that person would, and scale to many viewers to extract the predicted crowd response by averaging their collective reactions.
...
Learning from disagreement: A survey. {\it Journal of Artificial Intelligence Research} {\bf 72}:1385-1470.

\bibitem{plank2022}
Plank, B.\ (2022)
The ``problem'' of human label variation: On ground truth in data, modeling and evaluation. In {\it EMNLP}.
...
VILA: Learning image aesthetics from user comments with vision-language pretraining. In {\it CVPR}.

\bibitem{wu2024qalign}
Wu, H., Zhang, Z., Zhang, W., Chen, C., Liao, L.\ et al.\ (2024)
Q-Align: Teaching LMMs for visual scoring via discrete text-defined levels. In {\it ICML}.
...
Xu, J., Liu, X., Wu, Y., Tong, Y., Li, Q.\ et al.\ (2023)
ImageReward: Learning and evaluating human preferences for text-to-image generation. In {\it NeurIPS}.

\bibitem{kirstain2023pickapic}
Kirstain, Y., Polyak, A., Singer, U., Matiana, S., Penna, J.\ and Levy, O.\ (2023)
Pick-a-Pic: An open dataset of user preferences for text-to-image generation. In {\it NeurIPS}.

\bibitem{black2024ddpo}
Black, K., Janner, M., Du, Y., Kostrikov, I.\ and Levine, S.\ (2024)
Training diffusion models with reinforcement learning. In {\it ICLR}.

\bibitem{wallace2024dpo}
Wallace, B., Dang, M., Rafailov, R., Zhou, L., Lou, A.\ et al.\ (2024)
Diffusion model alignment using direct preference optimization. In {\it CVPR}.
